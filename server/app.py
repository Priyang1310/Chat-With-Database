...
def ask_endpoint():
    ...
    try:
        ...
        if not query:
            return jsonify({"error": "Query and collection name are required"}), 400
        
        # Process the query with the agent
        ans = agents.invoke(query + " answer with help of description section in table")["output"]
...
def connect_mysql():
    ...
    try:
        ...
        password = "Priyang1310"
        database = request.json.get('password')
